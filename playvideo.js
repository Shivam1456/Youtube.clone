...
const videos= async() => {
    ...
    try {
        let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&type=video&key=AIzaSyCWmsjslHkf5HrCvKjkSL-G89v3inCk-18&maxResults=20&order=viewCount&safeSearch=moderate`);
